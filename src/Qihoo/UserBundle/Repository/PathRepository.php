...
class PathRepository extends EntityRepository
{
    public function getList($start, $limit, $params = array())
    {
        ...
        $DQL_TOTAL = "SELECT COUNT(b) FROM QihooUserBundle:Path b";
        $DQL = "SELECT b FROM QihooUserBundle:Path b";
    ...
    public function getMenu()
    {
        ...
        $SQL = "SELECT p.id, p.name, p.menu_1 AS firstMenu, p.menu_2 AS secondMenu, p.route FROM qihoo_path p";
