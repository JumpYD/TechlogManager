...
use Qihoo\UserBundle\Entity\Auth;
...
class AuthController extends Controller
{
     ...
     * @Template("QihooUserBundle:Auth:list.html.twig")
     */
    public function listAction()
    {
        ...
        $rp = $em->getRepository('QihooUserBundle:Auth');
     ...
     * @Template("QihooUserBundle:Auth:query_result.html.twig")
     */
    public function queryAction()
    {
        ...
        $em = $this->getEM();
        list($total, $users) = $em->getRepository('QihooUserBundle:Auth')
     ...
     * @Template("QihooUserBundle:Auth:new.html.twig")
     */
     ...
     * @Template("QihooUserBundle:Auth:change.html.twig")
     */
     ...
     * @Template("QihooUserBundle:Auth:change_password.html.twig")
     */
