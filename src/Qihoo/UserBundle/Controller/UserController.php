...
class UserController extends Controller
{
     ...
     * @Template("QihooUserBundle:User:login.html.twig")
     */
    public function loginAction()
    {
        ...
        $rp = $em->getRepository('QihooUserBundle:User');
     ...
     * @Template("QihooUserBundle:User:homepage.html.twig")
     */
     ...
     * @Template("QihooUserBundle:User:list.html.twig")
     */
     ...
     * @Template("QihooUserBundle:User:add.html.twig")
     */
    public function addAction()
    {
        ...
        try {
            ...
            if ($id) {
                $User = $em->getRepository('QihooUserBundle:User')->find($id);
            } else {
                $User = new User();
            }
            ...
            if ($confirm) {
                $username = $request->get('username');
                $em = $this->getDoctrine()->getEntityManager();
                $entity = $em->getRepository('QihooUserBundle:Auth')->findOneByUsername($username);
                if (empty($entity))
     ...
     * @Template("QihooUserBundle:User:query_result.html.twig")
     */
    ...
    {
        $em = $this->getDoctrine()->getEntityManager();
        $result = $em->getRepository('QihooUserBundle:User')->getList($start, $limit, $queryParams);
    ...
    {
        $em       = $this->getDoctrine()->getEntityManager();
        $roleList = $em->getRepository('QihooUserBundle:Role')->getRoleList();
