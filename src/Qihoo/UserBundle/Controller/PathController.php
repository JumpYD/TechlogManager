...
use Qihoo\UserBundle\Entity\Path;
...
class PathController extends Controller
{
     ...
     * @Template("QihooUserBundle:Path:list.html.twig")
     */
    ...
    public function menuAction()
    {
        ...
        $result = $em->getRepository('QihooUserBundle:Path')->getMenu($params);
     ...
     * @Template("QihooUserBundle:Path:query_result.html.twig")
     */
     ...
     * @Template("QihooUserBundle:Path:add.html.twig")
     */
    public function addAction()
    {
        ...
        try {
            if ($id) {
                $path = $em->getRepository('QihooUserBundle:Path')->find($id);
            } else {
                $path = new Path();
            }
            ...
            if ($confirm) {
                ...
                $result = $em->getRepository('QihooUserBundle:Path')->findRoute($route, $secondMenu);
    ...
    {
        $em     = $this->getDoctrine()->getManager();
        $result = $em->getRepository('QihooUserBundle:Path')->getList($start, $limit, $queryParams);
