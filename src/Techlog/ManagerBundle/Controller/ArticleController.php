...
use Techlog\ManagerBundle\Entity\Article;
...
class ArticleController extends Controller
{
	 ...
	 * @Template("TechlogManagerBundle:Article:list.html.twig")
     */
	 ...
	 * @Template("TechlogManagerBundle:Article:query_result.html.twig")
     */
	 ...
	 * @Template("TechlogManagerBundle:Article:modify.html.twig")
     */
    ...
    public function modifybasicAction (Request $request)
	{
        ...
        return new JsonResponse(array('code'=>0, 'msg'=>'更新成功', 'url'=>$this->generateUrl('techlog_manager_article_list').'?article_id='.$id));
	}
